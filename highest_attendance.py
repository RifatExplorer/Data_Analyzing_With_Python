...
Q-3: The employee with the highest attendance."""
...
# The employee with the highest attendance.
max_attendance = max(employee_attendance.values())
for key,value in employee_attendance.items():
  if value == max(employee_attendance.values()):
    print(f"The employee with the most attendance is {key} with {max_attendance} days of attendance.")
